...
#include <ezTime.h>  // Getting the time and adjusting for DST, see "ezTime" in the Arduino Library manager: https://github.com/ropg/ezTime

#define TIMEZONE_DEFAULT "Europe/Tallinn" // https://en.wikipedia.org/wiki/List_of_tz_database_time_zones
